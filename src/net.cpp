...
bool CNode::ReceiveMsgBytes(const char *pch, unsigned int nBytes, bool& complete)
{
    ...
    while (nBytes > 0) {
        ...
        if (vRecvMsg.empty() ||
            ...
            vRecvMsg.push_back(CNetMessage(Params().MessageStartNetwork(), SER_NETWORK, INIT_PROTO_VERSION));
...
void CConnman::PushMessage(CNode* pnode, CSerializedNetMsg&& msg)
{
    ...
    CMessageHeader hdr(Params().MessageStartNetwork(), msg.command.c_str(), nMessageSize);
