...
{
    BOOST_CHECK(TestSplitHost("www.bitcoinvault.global", "www.bitcoinvault.global", -1));
    BOOST_CHECK(TestSplitHost("[www.bitcoinvault.global]", "www.bitcoinvault.global", -1));
    BOOST_CHECK(TestSplitHost("www.bitcoinvault.global:80", "www.bitcoinvault.global", 80));
    BOOST_CHECK(TestSplitHost("[www.bitcoinvault.global]:80", "www.bitcoinvault.global", 80));
