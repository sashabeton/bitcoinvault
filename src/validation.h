...
static const int BOOTSTRAP_PERIOD = 29850 + 8*26600; // ~4.5 years (BRIP-1)
static const int BITCOIN_HEAD_START = 4 * 210000; // 16 years (BRIP-1)
...
bool CheckBlock(const CBlock& block, CValidationState& state, const Consensus::Params& consensusParams, CBlockIndex* pindexPrev = nullptr, bool fCheckPOW = true, bool fCheckMerkleRoot = true);
