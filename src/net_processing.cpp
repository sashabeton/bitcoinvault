...
static constexpr int64_t STALE_CHECK_INTERVAL = 13 * 365 * 24 * 60 * 60; // Bitcoin: was 10 * 60; // 10 minutes
...
static constexpr int STALE_RELAY_AGE_LIMIT = 13 * 365 * 24 * 60 * 60; // Bitcoin: was 30 * 24 * 60 * 60;
