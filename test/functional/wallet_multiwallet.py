...
Verify that a broyaled node can load multiple wallet files
"""
import os
import shutil
import time
...
class MultiWalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(w5_info['immature_balance'], 350)
        ...
        for wallet_name, wallet in zip(wallet_names, wallets):
            ...
            assert_equal(info['immature_balance'], 350 if wallet is wallets[0] else 0)
        ...
        assert_equal(w1.getbalance(), 700)
