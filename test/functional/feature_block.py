...
class FullBlockTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure broyaled isn't accepting b26
        ...
        # Extend the b28 chain to make sure broyaled isn't accepting b28
        ...
        tx = self.create_and_sign_transaction(out[17], 176 * COIN)
        ...
        # broyaled doesn't disconnect us for sending a bloated block, but if we subsequently
