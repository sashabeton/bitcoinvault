...
# TestP2PConn: A peer we use to send messages to bvaultd, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes bvaultd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that bvaultd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bvaultd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bvaultd will not send blocktxn responses for blocks whose height is
