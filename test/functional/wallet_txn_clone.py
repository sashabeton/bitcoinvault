...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        node0_txid1 = self.nodes[0].sendtoaddress(node0_address1, starting_balance-31)
        ...
        # Check node0's total balance; should be same as before the clone, + 100 BTCR for 2 matured,
