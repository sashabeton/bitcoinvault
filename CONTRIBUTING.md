...
In accordance to creating a fair play implementation, the authors of this implementation believe
that "maintainer" status (and write access to the repository) should reflect participation and
influence over the network itself. In the Bitcoin ecosystem, contribution to the network is 
often measured with mining power.

To become a maintainer, assuming you have no prior relationship with existing maintainers, demonstrate 
your involvement in mining blocks. Your write access will be given following this demonstration.

Communication channels
----------------------

Discussion about codebase improvements ususally happens in GitHub issues and on pull
requests.
